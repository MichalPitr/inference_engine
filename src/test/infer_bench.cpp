...
int main(int argc, char** argv) {
    ...
    ModelLoader loader;
    global_engine = loader.load("/home/michal/code/inference_engine/models/mnist_ffn.onnx"); 
    global_input = load_input("/home/michal/code/inference_engine/inputs/image_0.ubyte");
